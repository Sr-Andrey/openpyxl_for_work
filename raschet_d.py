...
from Sbor import pok_1

current_directory = os.getcwd()
name_files1=input('Введите имя исходного файла: ')+'.xlsx'
wb=load_workbook(current_directory+'\\'+name_files1)

x,y,l=map(str, input("Введите строку и столбец брутто и номер листа книги \
Факт всего, через пробел, пример 41 aj 3: ",).split())
# x,y,l=41,'aj',3
x,l=int(x),int(l)
...
sheet=wb.active
# brutto vsego
pok_1['2.6.01'][2]=sheet.cell(x,y).value 
pok_1['2.6.03.3'][2]=sheet.cell(x,y+1).value
pok_1['2.6.03.5'][2]=(pok_1['2.6.01'][2]*pok_1['2.6.03.3'][2])/10000
# Dalnee sledovanie
pok_1['2.6.01.2.б.1'][2]=sheet.cell(x,y+6).value
pok_1['2.6.03.3.б.1'][2]=sheet.cell(x,y+7).value
pok_1['2.6.03.5.б.1'][2]=(pok_1['2.6.01.2.б.1'][2]*pok_1['2.6.03.3.б.1'][2])/10000
# hoz
pok_1['2.6.01.2.в'][2]=sheet.cell(x,y+9).value
pok_1['2.6.03.3.в'][2]=sheet.cell(x,y+10).value
pok_1['2.6.03.5.в'][2]=(pok_1['2.6.01.2.в'][2]*pok_1['2.6.03.3.в'][2])/10000
# prig
brutto_ppm=sheet.cell(x,y+3).value
udel_ppm=sheet.cell(x,y+4).value
potreblenie_ppm=(brutto_ppm*udel_ppm)/10000
brutto_ppp=sheet.cell(x,y+17).value
udel_ppp=sheet.cell(x,y+18).value
potreblenie_ppp=(brutto_ppp*udel_ppp)/10000
pok_1['2.6.01.2.б.2'][2]=brutto_ppm+brutto_ppp
pok_1['2.6.03.5.б.2'][2]=potreblenie_ppm+potreblenie_ppp
pok_1['2.6.03.3.б.2'][2]=(pok_1['2.6.03.5.б.2'][2]/pok_1['2.6.01.2.б.2'][2])*10000

pok_1['2.6.01.2'][2]=pok_1['2.6.01'][2]
pok_1['2.6.01.2.б'][2]=pok_1['2.6.01.2.б.2'][2]+pok_1['2.6.01.2.б.1'][2]
pok_1['2.6.01.2.в.1'][2]=pok_1['2.6.01.2.в'][2]
pok_1['2.6.03.3.в.1'][2]=pok_1['2.6.03.3.в'][2]
pok_1['2.6.03.5.б'][2]=pok_1['2.6.03.5.б.1'][2]+pok_1['2.6.03.5.б.2'][2]
pok_1['2.6.03.5.в.1'][2]=pok_1['2.6.03.5.в'][2]


prov_brutto=pok_1['2.6.01'][2]-pok_1['2.6.01.2.б.1'][2]-pok_1['2.6.01.2.в'][2]-pok_1['2.6.01.2.б.2'][2]
prov_potreblenie=pok_1['2.6.03.5'][2]-pok_1['2.6.03.5.б.1'][2]-pok_1['2.6.03.5.в'][2]-pok_1['2.6.03.5.б.2'][2]

if prov_brutto>0.1 and prov_potreblenie>0.01:
        print("Ошибка сумм по видам", prov_brutto, prov_potreblenie)
        sys.exit()
